...
firebase.auth().onAuthStateChanged(function(user) {
  ...
  if (user) {
    var userId = firebase.auth().currentUser.uid;
	 firebase.database().ref('/users/' + userId + "/firstname").once('value').then(function(snapshot) {
		  document.getElementById("loginbutton").innerHTML = "eshan"
	//	$("#loginbutton").html('Eshan')
